...
The dataset is from Kaggle, with the work done by DrGuillemo scraping
...
atheletes, our analysis will revolve around the 2016-17 season.
...
drops <- c("Year", "blanl", "blank2", "collage", "birth_city")
