...
The NAs indicate in FG. indicate that the user did not take any field goals at 
...
The main features in the data set are points scored and field goal percentage.
I want to determine which features are the best for predicting the points scored
for a player. I suspect that the field goal percentage, along with some other
variables, help build a predictive model for the points scored.
