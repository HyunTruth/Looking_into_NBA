...
```{r echo=FALSE, Bivariate_Plots}
cor(x = df$FG., y = df$PPM, use = "complete.obs")
```
...
```{r echo=FALSE, Bivariate_Plots}
cor(x = df$X2P., y = df$PPM, use = "complete.obs")
```
...
```{r echo=FALSE, Bivariate_Plots}
cor(x = df$X3P, y = df$PPM, use = "complete.obs")
```

```{r echo=FALSE, Bivariate_Plots}
ggplot(aes(x=FT., y=PPM), data = df) +
  geom_jitter(alpha = 0.2) +
  geom_smooth(method = "lm")
```

```{r echo=FALSE, Bivariate_Plots}
cor(x = df$FT., y = df$PPM, use = "complete.obs")
```

```{r echo=FALSE, Bivariate_Plots}
cor(x = df$X3PA, y = df$PPM, use = "complete.obs")
```
